...
- [ ] 4. custom module の到達性計測を実装する
- [ ] 4.1 (P) RTT・連続喪失数の状態機械を実装する
...
- [ ] 4.3 O-S-C グローバルへの配線(ping ループ・受信フィルタ・status 応答)を実装する
...
- [ ] 5.3 直結検証スペック(テストクライアント ↔ mock-unity)を書く
...
- [ ] 5.4 フルチェーン検証スペックとテスト一式の完走を確認する
